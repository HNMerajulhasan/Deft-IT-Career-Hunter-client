...
const CourseDetails = () => {
    ...
    const { _id, classes, details, course_name,title, hours, image, instructor, instructorImg
    } = courseDetails;
    return (
        <div >
            <Container >
                <div className='border border-2 border-danger m-5 py-3'>
                    ...
                    <div ref={ref}>
                        <div className='d-flex flex-column justify-content-center align-items-center my-5'>
                            ...
                            <div >
                                <ListGroup>
                                    <ListGroup.Item>What You will Get From Us?</ListGroup.Item>
